          ...
          {HOW_WE_WORK_STEPS.map((item) => {
            ...
            return (
              <MotionItem key={item.step} className="h-full">
                <article className="group flex h-full flex-col rounded-[22px] border border-slate-200/80 bg-white p-5 shadow-md shadow-slate-200/50 transition-all duration-300 hover:-translate-y-1.5 hover:border-brand-200/80 hover:shadow-xl hover:shadow-brand-500/10">
