...
const REMONT_PRICES: readonly PriceListGroup[] = [
  ...
  },
  {
    ...
    items: [
      { name: "Штробление под проводку (кирпич)", priceFrom: 590, unit: "за м²" },
      { name: "Штробление под проводку (бетон)", priceFrom: 790, unit: "за м²" },
      { name: "Штробление под трубы", priceFrom: 990, unit: "за м²" },
      { name: "Сверление отверстий в бетоне", priceFrom: 290 },
      { name: "Поклейка обоев", priceFrom: 200, unit: "за м²" },
      { name: "Укладка плитки", priceFrom: 900, unit: "за м²" },
      { name: "Монтаж натяжного потолка", priceFrom: 400, unit: "за м²" },
    ],
  },
];
